...
def receptionist_approve_patient_view(request):
    ...
    return render(request,'hospital/receptionist_approve_patient.html',{'patients':patients})
...
def receptionist_discharge_patient_view(request):
    patients=models.Patient.objects.all().filter(status=True)
    return render(request,'hospital/receptionist_discharge_patient.html',{'patients':patients})
